...
export const TypeSelectField = ({ name, label, options }: SelectTypeFieldProps) => (
  <>
    <InputLabel>{label}</InputLabel>
    <Field fullWidth style={{ marginBottom: "0.5em" }} label={label} component={FormikSelect} name={name}>
      {options.map((option) => (
...
export const HealthCheckRatingSelectField = ({ name, label, options }: SelectHealthCheckRatingFieldProps) => (
  <>
    <InputLabel>{label}</InputLabel>
    <Field fullWidth style={{ marginBottom: "0.5em" }} label={label} component={FormikSelect} name={name}>
      {options.map((option) => (
